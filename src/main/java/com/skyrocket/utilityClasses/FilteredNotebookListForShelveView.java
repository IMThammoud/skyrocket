...
public class FilteredNotebookListForShelveView implements ConvertNotebookListForShelveView {
    private String name;
    private int amount;
    private String type;
    ...
    public FilteredNotebookListForShelveView() {}
    ...
    public List<FilteredNotebookListForShelveView> filterOutNotUsedColumnsAndCreateNewListForShelveViewDashboard(List<Notebook> notebookList) {
        List<FilteredNotebookListForShelveView> filteredNotebookListForShelveView = new ArrayList<>();
        for (Notebook notebook : notebookList) {
            // I only get the necessary Fields here for the PDF
            filteredNotebookListForShelveView.add( new FilteredNotebookListForShelveView(
                    notebook.getName(),
                    notebook.getAmount(),
                    notebook.getType(),
